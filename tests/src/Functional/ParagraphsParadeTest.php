...
class ParagraphsParadeTest extends BrowserTestBase {
  ...
  public function testParagraphTypesConfiguration() {
    ...
    $expected_machine_names = ['parade_anchor', 'parade_background', 'parade_call_to_action', 'parade_color_scheme', 'field_enable_parallax', 'field_lead_text', 'parade_secondary_title', 'parade_title'];
